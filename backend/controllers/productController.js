...
const sampleProducts = [
    ...
    { name: 'Samsung Galaxy S24', description: 'Samsung Galaxy S24 with Snapdragon 8 Gen 3, 50MP camera, 5G, 128GB.', price: 79999, originalPrice: 94999, category: 'Electronics', image: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=600', stock: 35, rating: 4.7, numReviews: 340, featured: true },
    ...
    { name: 'Women\'s Floral Dress', description: 'Elegant floral print summer dress, lightweight fabric, available in S/M/L/XL.', price: 1499, originalPrice: 2999, category: 'Fashion', image: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?w=600', stock: 80, rating: 4.4, numReviews: 156, featured: true },
    { name: 'Men\'s Casual Hoodie', description: 'Soft cotton blend hoodie with kangaroo pocket, perfect for casual everyday wear.', price: 1299, originalPrice: 2499, category: 'Fashion', image: 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?w=600', stock: 100, rating: 4.3, numReviews: 234, featured: false },
    ...
    { name: 'Women\'s Saree', description: 'Pure silk Banarasi saree with golden zari work, perfect for weddings and festivals.', price: 4999, originalPrice: 8999, category: 'Fashion', image: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=600', stock: 25, rating: 4.7, numReviews: 145, featured: false },
    ...
    { name: 'Woodland Trekking Boots', description: 'Waterproof leather trekking boots with anti-slip sole, ideal for outdoor adventures.', price: 5999, originalPrice: 8999, category: 'Footwear', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600', stock: 30, rating: 4.6, numReviews: 145, featured: false },
    ...
    { name: 'Women\'s Handbag', description: 'Stylish PU leather handbag with multiple compartments, shoulder strap included.', price: 1799, originalPrice: 3499, category: 'Accessories', image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=600', stock: 45, rating: 4.3, numReviews: 134, featured: false },
    ...
    { name: 'LED Smart Bulb Set', description: 'Pack of 4 WiFi smart LED bulbs, 16 million colors, works with Alexa & Google Home.', price: 1999, originalPrice: 3499, category: 'Home', image: 'https://images.unsplash.com/photo-1550985616-10810253b84d?w=600', stock: 75, rating: 4.4, numReviews: 189, featured: false },
    { name: 'Memory Foam Pillow', description: 'Orthopedic cervical memory foam pillow, relieves neck pain, washable cover.', price: 1499, originalPrice: 2999, category: 'Home', image: 'https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=600', stock: 60, rating: 4.5, numReviews: 267, featured: true },

    // ===== BEAUTY (6) =====
    { name: 'Lakme 9to5 Lipstick Set', description: 'Set of 6 Lakme 9to5 matte lipsticks in trending shades, long lasting 12hr formula.', price: 1199, originalPrice: 1999, category: 'Beauty', image: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=600', stock: 90, rating: 4.5, numReviews: 445, featured: true },
    ...
    { name: 'Dyson Airwrap Styler', description: 'Multi-styler and dryer, curl, wave, smooth and dry hair simultaneously.', price: 44999, originalPrice: 54999, category: 'Beauty', image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600', stock: 18, rating: 4.8, numReviews: 234, featured: false },
    { name: 'Neutrogena Sunscreen SPF 50', description: 'Ultra sheer dry-touch sunscreen SPF 50+, non-greasy, water resistant, 88ml.', price: 499, originalPrice: 799, category: 'Beauty', image: 'https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?w=600', stock: 150, rating: 4.3, numReviews: 512, featured: false },
    { name: 'Philips Hair Dryer', description: 'Professional 2200W hair dryer with ionic technology, 3 heat settings, cool shot.', price: 2499, originalPrice: 3999, category: 'Beauty', image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600', stock: 40, rating: 4.4, numReviews: 189, featured: false },
    ...
    { name: 'Yoga Mat Premium', description: 'Extra thick 6mm non-slip yoga mat with carrying strap, eco-friendly TPE material.', price: 1499, originalPrice: 2499, category: 'Sports', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600', stock: 75, rating: 4.6, numReviews: 389, featured: true },
    ...
    { name: 'Decathlon Cycling Helmet', description: 'Lightweight road cycling helmet, 18 vents, adjustable fit system, CE certified.', price: 2999, originalPrice: 4999, category: 'Sports', image: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=600', stock: 35, rating: 4.4, numReviews: 112, featured: false },
...
const ensureProductsExist = async () => {
    try {
        ...
        if (count === 0) {
            ...
            // Auto-update all existing MongoDB products with fresh high-res image URLs
            for (const sp of sampleProducts) {
                await Product.updateOne({ name: sp.name }, { $set: { image: sp.image } })
            }
        }
    } catch (err) {
